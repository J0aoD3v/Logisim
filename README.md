# Executáveis para Logisim-evolution-3.8.0 e Logisim-2.7.1
Este repositório contém os executáveis do Logisim-evolution-3.8.0 e Logisim-2.7.1 criados pelo Launch4j. Agora, eles rodam perfeitamente sem o erro "this application requires a java runtime environment".

## Instruções para executar os programas caso continue com erro
